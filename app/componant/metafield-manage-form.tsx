    ...
    <div className="flex flex-col sm:flex-row items-end gap-3">
      ...
      <div className={`flex-shrink-0 w-full sm:w-auto ${metafields.length > 0 ? "flex-1" : ""}`}>
        {metafields.length === 0 ? (
          ...
          <button
            onClick={resetToHome}
            className="h-11 px-4 py-2 text-base cursor-pointer font-bold border border-[#dfe3e8] rounded-md hover:bg-gray-50 inline-flex items-center justify-center gap-2"
          >
    ...
    <div className="p-5 space-y-4">
                ...
                {csvData === 0 && (
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <button onClick={handleDownloadTemplate} className="text-xs cursor-pointer font-bold text-gray-500 uppercase flex items-center gap-1 hover:text-black transition-colors">
      ...
      <div className="flex items-center gap-3 pt-5 border-t border-[#f1f2f3]">
        <button
          ...
          className="flex-1 bg-red-600 text-white h-11 rounded-md font-bold text-base cursor-pointer hover:bg-red-700 disabled:bg-gray-200 disabled:text-gray-400 transition-all flex items-center justify-center gap-2"
        >
