...
export default function SimpleTagManager() {
  ...
  return (
    <AppProvider embedded apiKey={apiKey}>
      ...
      <div className="min-h-screen bg-[#f1f2f4] py-10 px-4 font-sans text-[#202223]">
              ...
              <section className="bg-white rounded-lg shadow-sm border border-[#dfe3e8] overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                  <div>
                    ...
                    <select
                      className="w-full bg-white border border-[#babfc3] rounded-md px-3 py-2 focus:border-[#008060] focus:ring-1 focus:ring-[#008060] outline-none transition-all disabled:bg-gray-50"
                      value={objectType}
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="bg-black text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-800 disabled:bg-gray-200 transition"
                      >
                        Add
                      </button>
                    </div>
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-md border border-dashed border-[#babfc3]">
                      ...
                      <button
                        ...
                        className={`text-xs flex items-center gap-1 text-[#008060] font-medium hover:underline ${isRunning ? "opacity-50 cursor-not-allowed pointer-events-none" : ""}`}
                        disabled={isRunning}
                      >
                    ...
                    {csvData.length > 0 && (
                      <div className="flex items-center gap-2 text-blue-700 text-sm font-medium bg-blue-50 p-2 rounded border border-blue-200">
                        <CheckCircle2 size={16} /> {csvData.length} records ready to process
                        <button
                          onClick={handleClearCSV}
                          className="ml-auto text-red-600 hover:underline disabled:opacity-50 disabled:cursor-not-allowed"
                          disabled={isRunning}
                        >
                          Remove
                        </button>
          ...
          {results.length > 0 && (
            <section className="bg-white rounded-lg shadow-sm border border-[#dfe3e8] overflow-hidden">
              <div className="p-5 border-b border-[#f1f2f3] flex justify-between items-center">
                ...
                {isFinished && (
                  <button onClick={downloadResults} className="text-sm font-medium flex items-center gap-1 text-black border border-black px-3 py-1 rounded hover:bg-gray-50">
