          ...
          <header className="flex justify-between items-end mb-4">
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Add tags to your resources manually or via bulk CSV upload.
              </p>
            </div>
            {isFinished && (
              <button
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        disabled={
                          tagInput.trim().length < 2 || isRunning || isFinished
                        }
                    ...
                    {tagError && (
                      <p className="text-red-600 text-xs mt-2">{tagError}</p>
                    )}
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      {tags.map((tag) => (
                        <span
                          key={tag}
                          className="inline-flex items-center  bg-[#f1f2f3] text-[#202223] px-3 py-1 rounded-full text-xs font-medium border border-[#dfe3e8]"
                        >
                          {tag}
                      ...
                      <>
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-md border border-dashed border-[#babfc3]">
                          <div className="flex gap-4">
                            <label
                              className={`flex items-center gap-2 text-sm cursor-pointer ${isRunning ? "opacity-50 cursor-not-allowed" : ""}`}
                            >
                              <input
                                type="radio"
            ...
            <section className="bg-white rounded-lg shadow-sm border border-[#dfe3e8] overflow-hidden">
              <div className="p-5 border-b border-[#f1f2f3] flex justify-between items-center">
                ...
                {isFinished && (
                  <button
                    ...
                    className="text-sm cursor-pointer font-medium flex items-center gap-1 text-black border border-black px-3 py-1 rounded hover:bg-gray-50"
                  >
              ...
              <div className="max-h-60 overflow-y-auto divide-y divide-gray-100">
                {results.map((r, idx) => (
                  <div
                    key={idx}
                    className="p-3 px-6 flex items-center justify-between text-sm"
                  >
                    <span className="text-gray-500 tabular-nums">
                      #{r.index}
                    </span>
                    <span className="flex-1 px-4 font-mono text-xs truncate">
                      {r.id}
                    </span>
                    {r.success ? (
