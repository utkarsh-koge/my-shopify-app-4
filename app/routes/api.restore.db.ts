  ...
  try {
    ...
    if (row?.namespace && row?.key) {
      ...
      if (row.operation === "Metafield-removed" || row.operation === "Metafield-remove") {
        console.log("🔁 OPERATION: Metafield-removed");
        console.log("📌 resolvedId:", resolvedId);
        console.log("📌 namespace:", namespace);
        console.log("📌 key:", key);
        console.log("📌 metafieldType:", metafieldType);
        console.log("📌 isListType:", isListType);
        console.log("📌 incoming raw value:", value, "type:", typeof value);

        // 🔹 LIST TYPE → MERGE + RESTORE
        if (isListType) {
          console.log("➡️ Entered LIST-TYPE restore block");
          ...
          console.log("🧩 normalized existingList:", existingList);
          console.log("🧩 normalized incomingList:", incomingList);

          const mergedList = Array.from(
            new Set([...existingList, ...incomingList]),
          );

          console.log("🔗 mergedList (final):", mergedList);
          console.log("📦 mergedList JSON:", JSON.stringify(mergedList));
          ...
          console.log("✅ updateSpecificMetafield result:", result);
        ...
        console.log("➡️ Entered NON-LIST restore block");

        console.log("📦 value sent directly:", value, "type:", typeof value);
