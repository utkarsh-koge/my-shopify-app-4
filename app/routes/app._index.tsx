    ...
    <div className="min-h-screen bg-[#f6f6f7] p-8 font-sans relative">
      ...
      <div className={`max-w-5xl mx-auto transition-opacity duration-300 ${isNavigating ? 'opacity-50' : 'opacity-100'}`}>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white border border-[#dfe3e8] rounded-md shadow-sm text-xs font-bold text-[#202223] hover:bg-gray-50 transition-all"
            >
              <HelpCircle size={14} />
              FAQ
            </button>
          ...
          {modules.map((module) => (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-2.5 bg-white border border-black text-black rounded-md text-xs font-bold hover:bg-black hover:text-white transition-all shadow-sm disabled:opacity-50"
              >
                {module.action}
                <ArrowRight size={14} />
              </button>
        ...
        <div className="mt-12 p-6 bg-white border border-[#dfe3e8] rounded-xl flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button
            onClick={() => handleNavigation("/history")}
            className="text-xs font-bold text-gray-500 hover:text-black underline underline-offset-4"
          >
