...
const FaqItem = ({ question, answer, icon: Icon, isOpen, onClick }: FaqItemProps) => {
    return (
        <div className="bg-white rounded-xl shadow-sm border border-[#dfe3e8] overflow-hidden transition-all duration-200 hover:border-black mb-4">
            <button
                onClick={onClick}
            ...
            >
                <div className="flex items-center gap-3">
                    {Icon && (
                        <div className={`p-2 rounded-lg border ${isOpen ? 'bg-black text-white border-black' : 'bg-[#fafbfb] border-[#f1f2f3] text-black'} transition-colors`}>
                            <Icon size={16} />
                        </div>
                    )}
                    <span className="font-bold text-sm text-[#202223]">{question}</span>
                </div>
                {isOpen ? (
            ...
            >
                <div className="p-4 pt-0 text-sm text-gray-500 leading-relaxed border-t border-[#f1f2f3] mt-0">
                    {answer}
                </div>
            </div>
        </div>
...
export default function FaqPage() {
    ...
    const faqs = [
        {
            ...
            answer: (
                <div className="space-y-3">
                    <p>
                        Tag MetaField Manager is a powerful bulk editing tool designed to help you manage tags and metafields across your Shopify store efficiently.
                    </p>
                    <p>
            ...
            answer: (
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="border border-[#dfe3e8] p-3 rounded-lg">
                            <h4 className="font-bold text-[#202223] mb-2">1. Global Removal</h4>
                        ...
                        <div className="border border-[#dfe3e8] p-3 rounded-lg">
                            <h4 className="font-bold text-[#202223] mb-2">2. Specific Removal</h4>
                            <p className="text-sm text-gray-500">
        ...
        },
        {
            ...
            answer: (
                <div>
                    ...
                    <div className="flex items-start gap-2 text-xs bg-blue-50 text-blue-800 p-3 rounded-md border border-blue-100">
    ...
    return (
        <div className="min-h-screen bg-[#f6f6f7] pb-10 relative">
            <div className="max-w-3xl mx-auto p-4 font-sans text-gray-900">
                ...
                <div className="text-center mb-6">
                    <h1 className="text-2xl font-bold text-[#202223] mb-2 tracking-tight">
                        Frequently Asked Questions
                    </h1>
                    <p className="text-sm text-gray-500 max-w-xl mx-auto">
                        Learn how to get the most out of Tag MetaField Manager. Manage your store's data with confidence and ease.
                    </p>
                </div>
