...
export default function SingleMetafieldViewer() {
  ...
  //       const value = rawValue; // DO NOT trim globally
  ...
  //         list.forEach(v => {
  //           if (!v.startsWith("gid://")) {
  //             throw new Error("Invalid GID in list reference");
  //           }
  //         });
  ...
  //       /* ---------- SINGLE REFERENCES ---------- */
  //       if (type?.includes("_reference")) {
  //         if (!String(value).trim().startsWith("gid://")) {
  //           throw new Error("Invalid GID reference");
  //         }
  ...
  //       namespace: selectedMetafield.namespace,
  //       key: selectedMetafield.key,
  //       value: normalizedValue, // ANY TYPE: text, number, json, date, comma
  //       raw: cols,
