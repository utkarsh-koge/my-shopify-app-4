...
export default function TagManager() {
  ...
  return (
    <AppProvider embedded apiKey={apiKey}>
      <div className="min-h-screen bg-[#f1f2f4] p-8 font-sans">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-gray-300 px-3 py-2 rounded-lg text-gray-900 focus:ring-2 focus:ring-gray-800 focus:border-gray-800 outline-none transition-all disabled:bg-gray-100"
                    >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full py-2 border border-dashed border-gray-300 rounded-lg text-gray-500 hover:text-gray-800 hover:border-gray-400 hover:bg-gray-50 transition-all flex items-center justify-center gap-2 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <div className="pt-4 flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium shadow-sm"
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 animate-in fade-in slide-in-from-top-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <label className={`relative flex items-start p-4 cursor-pointer rounded-lg border transition-all ${removalMode === "global" ? "border-black bg-gray-50 ring-1 ring-black" : "border-gray-200 hover:border-gray-300"}`}>
                          ...
                          />
                          <div>
                            <span className="block font-medium text-gray-900">Global Removal</span>
                      ...
                      {removalMode === "specific" && (
                        <div className="bg-gray-50 rounded-lg p-5 border border-gray-200 mb-6">
                          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
                            ...
                            <button type="button" onClick={handleDownloadTemplate} className="ml-auto text-xs text-gray-600 underline flex items-center gap-1 hover:text-black">
                          ...
                          />
                          {csvIds.length > 0 && <p className="mt-2 text-xs font-bold text-blue-700">{csvIds.length} items loaded.</p>}
                        </div>
                      )}

                      <button
                        disabled={removalMode === "specific" && csvIds.length === 0}
                        className="w-full bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors font-medium shadow-sm flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-400"
