                          ...
                          {csvIds.length === 0 ? (
                            <>
                              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
                                ...
                                <button type="button" onClick={handleDownloadTemplate} className="ml-auto cursor-pointer text-xs text-[#008060] underline flex items-center gap-1 hover:text-black">
